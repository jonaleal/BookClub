                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/BookClub/book-club/update-form?clubId=${bookClub.clubId}" class="btn btn-primary">Actualizar</a>
                                <a href="/BookClub/book-club/delete?clubId=${bookClub.clubId}" class="btn btn-danger">Eliminar</a>
                            </div>
                        </div>
                    </div>  
                </c:forEach>
